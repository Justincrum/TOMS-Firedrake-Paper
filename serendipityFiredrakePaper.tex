...
\begin{figure}[h!]
  ...
  \begin{subfigure}[h]{0.5\textwidth}
    \centering
    \captionlistentry{}
    %\caption{2D Primal Poisson Error Analysis}
  ...
  \begin{subfigure}[h]{0.5\textwidth}
    \centering
    \captionlistentry{}
    %\caption{2D Mixed Poisson Error Analysis}
    \begin{tikzpicture}[scale=0.88]
      \begin{loglogaxis}[xlabel={Degrees of Freedom}, ylabel={Error},
             ylabel near ticks, ymax=1e-1, ymin=1e-11, xmax=2e6, xmin=3e2,
             legend pos=south west, legend style={font=\tiny} ,
             cycle list name=color list, title={2D Mixed Poisson Error Analysis}]
        %\addplot+[only marks, orange] table [x=Dofs,y=Time,col sep=comma]{PrimalPoissonSerendipity3dO4.csv};
        \addplot[red]
  ...
  \begin{subfigure}[h]{0.5\textwidth}
    ...
    \begin{tikzpicture}[scale=0.88]
      \begin{loglogaxis}[xlabel={Degrees of Freedom}, ylabel={Error},
             ...
             legend pos=south west, legend style={font=\tiny} ,
             cycle list name=color list, title={3D Primal Poisson Error Analysis}]
        %\addplot+[only marks, orange] table [x=Dofs,y=Time,col sep=comma]{PrimalPoissonSerendipity3dO4.csv};
        \addplot[red]
