...
\end{figure}
   ...
   \justin{While reducing the number of DOFs will impact the accuracy of the element, we are interested in determining if there is a way to make this choice to gain accuracy while not increasing the DOFs required to do so.  
   ...
   Thus we believe that a  user making a choice to use trimmed serendipity elements at an increased order may be a meaningful way to achieve a more accurate solution.}
