...
\begin{figure}[h!]
  ...
  \includegraphics[width=0.75\textwidth]{EnergyErrorSerendipityLagrange.png}
\end{figure}
...
\begin{figure}[h!]
  ...
  \includegraphics[width=0.75\textwidth]{Iterative_Mixed_Poisson_RTCF_vs_Sminus.png}
\end{figure}

\begin{figure}[h!]
  \caption{Degrees of Freedom vs Error analysis of projection using $S^-(\text{Curl})$ and RTCE.}
  \includegraphics[width=0.75\textwidth]{2d-curl-Projection.png}
\end{figure}
...
\begin{figure}[h]
  ...
  \includegraphics[width=0.75\textwidth]{3d_Mixed_Poisson.png}
\end{figure}
