...
\end{figure}
   ...
   Seeing how such back-of-the-envelope calculations might bear out in a practical context requires the thorough implementation provided in this paper.\justin{While reducing the number of DOFs will impact the accuracy of the element, we are interested in determining if there is a way to make this choice to gain accuracy while not increasing the DOFs required to do so.  
