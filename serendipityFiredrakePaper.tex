...
%\end{aligned}
%\end{equation*}
We assume Neumann boundary conditions so that the integral over $\Gamma$ is $0$. %\lm{I had a go at fixing this, but the formulation is still imprecise. What are the boundary data, what are $\Sigma$ and $V$?}
